...
var $author$project$HangmanModels$initRecord = {guessedChars: $elm$core$Set$empty, hangmanPhrase: ' ', inputField: ''};
...
var $author$project$HangmanHelpers$getRandomPhrase = function (rndNum) {
	return A2(
		$elm$core$String$join,
		' ',
		_List_fromArray(
			[
				...
				var _v0 = A2(
					$elm$core$Array$get,
					rndNum,
					$author$project$HangmanHelpers$alphabeticWordsFromText($author$project$HangmanSourceTexts$sourceText));
				if (_v0.$ === 'Nothing') {
					return 'default';
				} else {
					var string = _v0.a;
		...
		switch (message.$) {
			...
			case 'NewRandomTextIndex':
				...
				return $author$project$HangmanModels$initWithHangmanPhrase(
					$author$project$HangmanHelpers$getRandomPhrase(index));
			default:
...
var $author$project$HangmanViews$mainButtonsView = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$HangmanViews$mainButtonsView,
